...
from server.db.repository.knowledge_file_repository import get_file_detail, get_kb_file_details
...
def rename_file(
    ...
    print("************************************")
    print("************************************")
    print("文件"+os.path.abspath(__file__)+"第"+str(sys._getframe().f_lineno)+"行，添加数据库中文件重命名操作。")
    print("************************************")
    print("************************************")
