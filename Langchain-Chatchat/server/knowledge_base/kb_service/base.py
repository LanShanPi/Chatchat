...
class KBService(ABC):
    ...
    def rename_kb(self,new_knowledge_name):
        print("************************************")
        print("************************************")
        print("文件"+os.path.abspath(__file__)+"第"+str(sys._getframe().f_lineno)+"行，添加数据库重命名函数。")
        print("************************************")
        print("************************************")
        """
        重命名知识库
    ...
    def rename_file(self,file_name,new_file_name):
        print("************************************")
        print("************************************")
        print("文件"+os.path.abspath(__file__)+"第"+str(sys._getframe().f_lineno)+"行，添加数据库中文件重命名函数。")
        print("************************************")
        print("************************************")
    ...
    # @abstractmethod
    # def do_rename_kb(self):
    #     print("************************************")
    #     print("************************************")
    #     print("文件"+os.path.abspath(__file__)+"第"+str(sys._getframe().f_lineno)+"行，添加数据库重命名子类。")
    #     print("************************************")
    #     print("************************************")
    #     """
    #     重命名数据库子类实自己逻辑
