...
def list_docs_from_db(session,
    ...
    print("************************************")
    print("************************************")
    print("文件"+os.path.abspath(__file__)+"第"+str(sys._getframe().f_lineno)+"行，作出修改")
    print("************************************")
    print("************************************")
...
@with_session
def rename_file_in_db(session,file_name,new_file_name):
    print("************************************")
    print("************************************")
    print("文件"+os.path.abspath(__file__)+"第"+str(sys._getframe().f_lineno)+"行，添加数据库中文件重命名。")
    print("************************************")
    print("************************************")
    return True
