...
class ApiRequest:
    ...
    def rename_knowledge_base(self,kb_name:str,new_kb_name:str,):
        '''
        对应api.py/knowledge_base/rename_knowledge_base接口
        '''
        print("************************************")
        print("************************************")
        print("文件"+os.path.abspath(__file__)+"第"+str(sys._getframe().f_lineno)+"行，前端添加重命名知识库函数rename_knowledge_base。")
        print("************************************")
        print("************************************")
        data = {
            "knowledge_base_name":kb_name,
            "new_knowledge_name":new_kb_name
        }
        response = self.post(
